 ...
 */
final class Version20190127222717 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dmp (id INT AUTO_INCREMENT NOT NULL, node_managing_id INT DEFAULT NULL, surname VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, social_number BIGINT UNSIGNED NOT NULL, birth_date DATE DEFAULT NULL, birth_place VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, measures LONGTEXT DEFAULT NULL, dosage LONGTEXT DEFAULT NULL, INDEX IDX_30C9DE387E10622A (node_managing_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE personnal (id INT AUTO_INCREMENT NOT NULL, role_id INT DEFAULT NULL, hospital_node_id INT DEFAULT NULL, assignment_id INT DEFAULT NULL, surname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, INDEX IDX_C2D036DAD60322AC (role_id), INDEX IDX_C2D036DAB4B0FE2C (hospital_node_id), INDEX IDX_C2D036DAD19302F8 (assignment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE exam (id INT AUTO_INCREMENT NOT NULL, dmp_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, state TINYINT(1) NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_38BBA6C6B13AE3AD (dmp_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE exam ADD CONSTRAINT FK_38BBA6C6B13AE3AD FOREIGN KEY (dmp_id) REFERENCES dmp (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exam DROP FOREIGN KEY FK_38BBA6C6B13AE3AD');
