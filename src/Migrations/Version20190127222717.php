...
final class Version20190127222717 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE exam (id INT AUTO_INCREMENT NOT NULL, dmp_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, state TINYINT(1) NOT NULL, content LONGTEXT NULL, INDEX IDX_38BBA6C6B13AE3AD (dmp_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
