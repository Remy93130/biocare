 ...
 */
final class Version20190105152721 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dmp (id INT AUTO_INCREMENT NOT NULL, node_managing_id INT DEFAULT NULL, surname VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, social_number VARCHAR(255) NOT NULL, birth_date DATE DEFAULT NULL, birth_place VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, INDEX IDX_30C9DE387E10622A (node_managing_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE file (id INT AUTO_INCREMENT NOT NULL, act_id INT NOT NULL, file VARCHAR(255) NOT NULL, INDEX IDX_8C9F3610D1A55B28 (act_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE hospital_node (id INT AUTO_INCREMENT NOT NULL, responsible_id INT NOT NULL, ancestor_node_id INT DEFAULT NULL, type_node_id INT NOT NULL, UNIQUE INDEX UNIQ_49E4204602AD315 (responsible_id), INDEX IDX_49E4204834EAE72 (ancestor_node_id), INDEX IDX_49E42046E2CF022 (type_node_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE personnal (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, hospital_node_id INT NOT NULL, assignment_id INT NOT NULL, surname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_C2D036DAD60322AC (role_id), INDEX IDX_C2D036DAB4B0FE2C (hospital_node_id), INDEX IDX_C2D036DAD19302F8 (assignment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_node (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
